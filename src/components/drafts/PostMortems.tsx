      ...
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <header style={{ marginBottom: '80px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
            ...
            <span style={{ fontSize: '12px', letterSpacing: '0', textTransform: 'uppercase', color: '#ef4444', fontWeight: 600 }}>Post-Mortems</span>
          </div>
        ...
        <article style={{ marginBottom: '80px', paddingBottom: '80px', borderBottom: '1px solid var(--glass-border)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '24px', marginBottom: '24px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0', }}>Assumption</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '24px', marginBottom: '32px' }}>
            <div style={{ color: 'var(--text-secondary)', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0', }}>Reality</div>
            <div style={{ color: 'var(--text-primary)', fontSize: '16px', lineHeight: 1.6 }}>
          ...
          <div style={{ backgroundColor: 'rgba(239, 68, 68, 0.05)', border: '1px solid rgba(239, 68, 68, 0.2)', padding: '32px', borderRadius: '16px' }}>
            <h4 style={{ color: '#ef4444', marginBottom: '12px', fontSize: '14px', letterSpacing: '0', textTransform: 'uppercase' }}>What I do differently now</h4>
        ...
        <article>
          ...
          <div style={{ backgroundColor: 'rgba(234, 179, 8, 0.05)', border: '1px solid rgba(234, 179, 8, 0.2)', padding: '32px', borderRadius: '16px' }}>
            <h4 style={{ color: '#eab308', marginBottom: '12px', fontSize: '14px', letterSpacing: '0', textTransform: 'uppercase' }}>What I do differently now</h4>
            <p style={{ margin: 0, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
