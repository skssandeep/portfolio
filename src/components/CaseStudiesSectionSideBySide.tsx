...
const staggerContainer = {
  ...
  show: {
    opacity: 1,
    transition: {
      staggerChildren: 0.2, // Slightly slower stagger for more elegance
      delayChildren: 0.2
    }
  }
};
...
const staggerItem = {
  hidden: { opacity: 0, y: 40 }, // Start slightly lower
  show: { 
    opacity: 1, 
    y: 0,
    transition: {
      duration: 1.0, // Longer duration
      ease: [0.16, 1, 0.3, 1] // Buttery smooth custom cubic-bezier ease-out
    }
  }
};
      ...
      <div className="container" style={{ maxWidth: '1600px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '160px' }}>
          {caseStudies.map((study, index) => {
            ...
            return (
              <div key={study.id} className="case-study-row" style={{
                display: 'grid',
                ...
                >
                  ...
                  <motion.div variants={staggerItem} style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
