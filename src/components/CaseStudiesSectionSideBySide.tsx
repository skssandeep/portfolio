  ...
  return (
    <div ref={ref} className="case-study-row grid gap-12 md:gap-20 w-full" style={{
      ...
      <motion.div 
        ...
        paddingTop: study.title === 'SnipKeep' ? (isMobile ? '60px' : '100px') : '40px', 
        paddingBottom: study.title === 'SnipKeep' ? (isMobile ? '24px' : '40px') : '0', 
        paddingLeft: '20px',
        paddingRight: '20px',
      ...
      >
        ...
        <motion.img 
          ...
          style={{
            scale: imgScale,
            y: imgY,
            width: study.title === 'SnipKeep' ? (isMobile ? '85%' : '70%') : '100%',
            height: 'auto',
            objectFit: 'contain',
