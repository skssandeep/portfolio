...
export const SmartEPPCaseStudy = () => {
  ...
  return (
    <div style={{ background: 'var(--bg-color)', minHeight: '100vh', paddingBottom: '120px', overflowX: 'hidden' }}>
      ...
      <section style={{ paddingTop: '100px', paddingBottom: '0', background: 'var(--bg-color)', position: 'relative', overflowX: 'clip', overflowY: 'visible' }}>
        <div className="container" style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '40px' }}>
          ...
          <div style={{ flex: '1 1 400px', position: 'relative', zIndex: 5, minHeight: '600px' }}>
            ...
            <motion.img 
              ...
              style={{ position: 'absolute', top: '0', left: '-25%', width: '175%', maxWidth: '1200px', transform: 'translateY(-18%)', objectFit: 'contain', zIndex: 2, filter: 'drop-shadow(0 30px 60px rgba(0,0,0,0.6))' }}
            />
          </div>
